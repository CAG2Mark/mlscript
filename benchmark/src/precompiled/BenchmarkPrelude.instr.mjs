...
let BenchmarkPrelude1, b, Cont$func$helper$BenchmarkPrelude$_mls_L0_316_359$1, Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$1, Cont$func$helper$BenchmarkPrelude$_mls_L0_316_359$$ctor, Cont$func$helper$BenchmarkPrelude$_mls_L0_316_359$$, Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$ctor, Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$;
b = benchmark;
Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$ = function Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$(fn$0, start$1, res$2, end$3, tmp$4, tmp$5, tmp$6, tmp$7, tmp$8, tmp$9, curDepth$10, stackDelayRes$11, pc) {
  let tmp;
  tmp = new Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$1.class(pc);
  return tmp(fn$0, start$1, res$2, end$3, tmp$4, tmp$5, tmp$6, tmp$7, tmp$8, tmp$9, curDepth$10, stackDelayRes$11)
};
Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$ctor = function Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$ctor(fn$0, start$1, res$2, end$3, tmp$4, tmp$5, tmp$6, tmp$7, tmp$8, tmp$9, curDepth$10, stackDelayRes$11) {
  return (pc) => {
    let tmp;
    tmp = new Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$1.class(pc);
    return tmp(fn$0, start$1, res$2, end$3, tmp$4, tmp$5, tmp$6, tmp$7, tmp$8, tmp$9, curDepth$10, stackDelayRes$11)
...
Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$1 = function Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$(pc1) {
  return (fn$01, start$11, res$21, end$31, tmp$41, tmp$51, tmp$61, tmp$71, tmp$81, tmp$91, curDepth$101, stackDelayRes$111) => {
    return new Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$.class(pc1)(fn$01, start$11, res$21, end$31, tmp$41, tmp$51, tmp$61, tmp$71, tmp$81, tmp$91, curDepth$101, stackDelayRes$111);
  }
};
Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$1.class = class Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$ extends runtime.FunctionContFrame.class {
  constructor(pc) {
  ...
  resume(value$) {
    ...
    contLoop: while (true) {
      if (this.pc === 3) {
        ...
        runtime.stackDepth = runtime.stackDepth + 1;
        return Predef.print(this.tmp$9)
      }
      break;
    }
  }
  toString() { return "Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$(" + globalThis.Predef.render(this.pc) + ")"; }
};
...
BenchmarkPrelude1 = class BenchmarkPrelude {
  ...
  static benchmark(fn) {
    ...
    stackDelayRes = runtime.checkDepth();
    if (stackDelayRes instanceof runtime.EffectSig.class) {
      stackDelayRes.contTrace.last.next = Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$(fn, start, res, end, tmp, tmp1, tmp2, tmp3, tmp4, tmp5, curDepth, stackDelayRes, 3);
      stackDelayRes.contTrace.last = stackDelayRes.contTrace.last.next;
      return stackDelayRes
    }
    runtime.stackDepth = runtime.stackDepth + 1;
    ...
    if (tmp instanceof runtime.EffectSig.class) {
      tmp.contTrace.last.next = Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$(fn, start, res, end, tmp, tmp1, tmp2, tmp3, tmp4, tmp5, curDepth, stackDelayRes, 4);
      tmp.contTrace.last = tmp.contTrace.last.next;
      return tmp
    }
    tmp = runtime.resetDepth(tmp, curDepth);
    ...
    if (tmp1 instanceof runtime.EffectSig.class) {
      tmp1.contTrace.last.next = Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$(fn, start, res, end, tmp, tmp1, tmp2, tmp3, tmp4, tmp5, curDepth, stackDelayRes, 5);
    ...
    if (tmp2 instanceof runtime.EffectSig.class) {
      tmp2.contTrace.last.next = Cont$func$benchmark$BenchmarkPrelude$_mls_L0_372_799$$(fn, start, res, end, tmp, tmp1, tmp2, tmp3, tmp4, tmp5, curDepth, stackDelayRes, 6);
