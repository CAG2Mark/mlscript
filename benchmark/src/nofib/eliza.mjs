...
lz_map = function lz_map(f, ls) {
  ...
  lambda1 = (undefined, function () {
    ...
    if (ls instanceof NofibPrelude.Nil.class) {
      ...
      h = param0;
      t = param1;
      tmp336 = runtime.safeCall(f(h));
      tmp337 = lz_map(f, t);
      return NofibPrelude.LzCons(tmp336, tmp337)
    } else {
      throw new globalThis.Error("match error");
    }
  });
  tmp335 = lambda1;
  return NofibPrelude.lazy(tmp335)
};
append_lz = function append_lz(xs, ys) {
  let param0, param1, h, t, lambda1;
  if (xs instanceof NofibPrelude.Nil.class) {
    ...
    lambda1 = (undefined, function () {
      let tmp335;
      tmp335 = append_lz(t, ys);
      return NofibPrelude.LzCons(h, tmp335)
    });
...
cycle = function cycle(xs) {
  let tmp335, lambda1;
  lambda1 = (undefined, function () {
    return cycle(xs)
  });
  tmp335 = NofibPrelude.lazy(lambda1);
  return append_lz(xs, tmp335)
};
isSpace = function isSpace(c) {
  return c === " "
};
words = function words(s) {
  let scrut, param0, param1, h, t, scrut1, first1, first0, w, s_, tmp335, tmp336;
  ...
  if (scrut instanceof NofibPrelude.Nil.class) {
    ...
    h = param0;
    t = param1;
    tmp335 = NofibPrelude.Cons(h, t);
    scrut1 = NofibPrelude.break_(isSpace, tmp335);
    if (globalThis.Array.isArray(scrut1) && scrut1.length === 2) {
      ...
      s_ = first1;
      tmp336 = words(s_);
      return NofibPrelude.Cons(w, tmp336)
    } else {
      throw new globalThis.Error("match error");
    }
  } else {
...
unwords = function unwords(ws) {
  let go, param0, param1, w, ws1, tmp335;
  go = function go(ws2) {
    let param01, param11, w1, ws3, tmp336, tmp337;
    if (ws2 instanceof NofibPrelude.Nil.class) {
      ...
      ws3 = param11;
      tmp336 = go(ws3);
      tmp337 = NofibPrelude.append(w1, tmp336);
      return NofibPrelude.Cons(" ", tmp337)
    } else {
      throw new globalThis.Error("match error");
    }
  };
  if (ws instanceof NofibPrelude.Nil.class) {
    ...
    ws1 = param1;
    tmp335 = go(ws1);
    return NofibPrelude.append(w, tmp335)
  } else {
    throw new globalThis.Error("match error");
  }
};
null_lz = function null_lz(ls) {
...
trim = function trim(ls) {
  let cons, tmp335, lambda1;
  cons = function cons(x, xs) {
    let scrut, scrut1, tmp336;
    tmp336 = NofibPrelude.nofibStringToList(" .!?,");
    scrut = NofibPrelude.inList(x, tmp336);
    if (scrut === true) {
  ...
  lambda1 = (undefined, function (x) {
    let tmp336;
    tmp336 = NofibPrelude.nofibStringToList(" .!?,");
    return NofibPrelude.inList(x, tmp336)
  });
  tmp335 = NofibPrelude.dropWhile(lambda1, ls);
  return NofibPrelude.foldr(cons, NofibPrelude.Nil, tmp335)
};
repeated = function repeated(kt_rp) {
...
newKeyTab = function newKeyTab(kt_, kt_rp) {
...
keyTabOf = function keyTabOf(kt_rp) {
  let first1, first0, kt, rp;
  if (globalThis.Array.isArray(kt_rp) && kt_rp.length === 2) {
    first0 = kt_rp[0];
    first1 = kt_rp[1];
...
makeResponse = function makeResponse(cs, us) {
  let param0, param1, cs_, cs_1, tmp335, tmp336, tmp337, tmp338, tmp339, tmp340, tmp341, tmp342;
  if (cs instanceof NofibPrelude.Cons.class) {
    param0 = cs.head;
    param1 = cs.tail;
    if (param0 === "?") {
      cs_1 = param1;
      tmp335 = NofibPrelude.nofibStringToList(" ");
      tmp336 = NofibPrelude.nofibStringToList("?");
      tmp337 = NofibPrelude.append(us, tmp336);
      tmp338 = NofibPrelude.append(tmp335, tmp337);
      return NofibPrelude.append(cs_1, tmp338)
    } else if (param0 === ".") {
      cs_ = param1;
      tmp339 = NofibPrelude.nofibStringToList(" ");
      tmp340 = NofibPrelude.nofibStringToList(".");
      tmp341 = NofibPrelude.append(us, tmp340);
      tmp342 = NofibPrelude.append(tmp339, tmp341);
      return NofibPrelude.append(cs_, tmp342)
    } else {
      return cs
    }
  } else {
...
prefix = function prefix(xxs, yys) {
  let param0, param1, x, xs, scrut, param01, param11, y, ys, tmp335, tmp336;
  if (xxs instanceof NofibPrelude.Nil.class) {
    ...
    if (scrut instanceof NofibPrelude.LzNil.class) {
      ...
      y = param01;
      ys = param11;
      tmp335 = NofibPrelude.listEq(x, y);
      tmp336 = prefix(xs, ys);
      return tmp335 && tmp336
    } else {
      throw new globalThis.Error("match error");
    }
  } else {
...
tails = function tails(xs) {
  let tmp335, lambda1;
  lambda1 = (undefined, function () {
    let xss, tmp336, tmp337;
    if (xs instanceof NofibPrelude.Nil.class) {
      return NofibPrelude.LzNil
    } else {
      xss = xs;
      tmp336 = NofibPrelude.tail(xss);
      tmp337 = tails(tmp336);
      return NofibPrelude.LzCons(xss, tmp337)
    }
  });
  tmp335 = lambda1;
  return NofibPrelude.lazy(tmp335)
};
ucase = function ucase(ls) {
  return NofibPrelude.map(toUpper, ls)
};
conjug = function conjug(d, w) {
  let maybe1, conj, trailingI, tmp335, tmp336, tmp337;
  maybe1 = function maybe(d1, xs) {
    let scrut;
  ...
  conj = function conj(w1) {
    let lscomp2, tmp338, tmp339, tmp340;
    lscomp2 = function lscomp(ls) {
      let param0, param1, first1, first0, w_, m, t, scrut, tmp341, tmp342;
      if (ls instanceof NofibPrelude.Nil.class) {
        return NofibPrelude.Nil
      } else if (ls instanceof NofibPrelude.Cons.class) {
        param0 = ls.head;
        ...
        if (globalThis.Array.isArray(param0) && param0.length === 2) {
          ...
          t = param1;
          tmp341 = ucase(w1);
          scrut = NofibPrelude.listEq(tmp341, w_);
          if (scrut === true) {
            tmp342 = lscomp2(t);
            return NofibPrelude.Cons(m, tmp342)
          } else {
            return lscomp2(t)
          }
        } else {
    ...
    tmp338 = lscomp2(conjugates);
    tmp339 = NofibPrelude.Cons(w1, NofibPrelude.Nil);
    tmp340 = NofibPrelude.append(tmp338, tmp339);
    return NofibPrelude.head(tmp340)
  };
  trailingI = function trailingI(ls) {
    let cons;
    cons = function cons(x, xs) {
      let scrut, tmp338, tmp339, tmp340, tmp341;
      tmp338 = NofibPrelude.nofibStringToList("I");
      tmp339 = NofibPrelude.listEq(x, tmp338);
      tmp340 = NofibPrelude.null_(xs);
      scrut = tmp339 && tmp340;
      if (scrut === true) {
        tmp341 = NofibPrelude.nofibStringToList("me");
        return NofibPrelude.Cons(tmp341, NofibPrelude.Nil)
      } else {
        return NofibPrelude.Cons(x, xs)
      }
    };
  ...
  tmp335 = maybe1(d, w);
  tmp336 = NofibPrelude.map(conj, tmp335);
  tmp337 = trailingI(tmp336);
  return unwords(tmp337)
};
replies = function replies(key, l) {
  let tmp335, tmp336, tmp337, lambda1, lambda2;
  lambda1 = (undefined, function (x) {
    let tmp338, tmp339;
    tmp338 = NofibPrelude.listLen(key);
    tmp339 = NofibPrelude.drop(tmp338, x);
    return conjug(l, tmp339)
  });
  tmp335 = lambda1;
  tmp336 = tails(l);
  lambda2 = (undefined, function (ls) {
    let tmp338;
    tmp338 = lz_map(ucase, ls);
    return prefix(key, tmp338)
  });
  tmp337 = NofibPrelude.filter_lz(lambda2, tmp336);
  return NofibPrelude.map_lz(tmp335, tmp337)
};
answer = function answer(st, l) {
  let ans, cons, scrut, first1, first0, response, kt, tmp335, tmp336;
  cons = function cons(e, r_es) {
    let first11, first01, r, es, tmp337;
    if (globalThis.Array.isArray(r_es) && r_es.length === 2) {
      first01 = r_es[0];
      first11 = r_es[1];
      r = first01;
      es = first11;
      tmp337 = NofibPrelude.Cons(e, es);
      return [
        r,
        tmp337
      ]
  ...
  ans = function ans(e_es, l1) {
    let param0, param1, first11, first01, key, a_as, es, scrut1, param01, param11, a, as_, rs, scrut2, tmp337, tmp338, tmp339, tmp340, tmp341;
      ...
      if (globalThis.Array.isArray(param0) && param0.length === 2) {
        ...
        if (scrut1 instanceof NofibPrelude.LzCons.class) {
          ...
          if (scrut2 === true) {
            ...
            tmp339 = NofibPrelude.head_lz(rs);
            tmp340 = makeResponse(a, tmp339);
            tmp341 = NofibPrelude.Cons([
              key,
              as_
            ], es);
            return [
...
session = function session(rs, prev, ls) {
  let param0, param1, l, ls1, scrut, scrut1, first1, first0, response, rs_, tmp335, tmp336, tmp337, tmp338;
  if (ls instanceof NofibPrelude.Nil.class) {
    return NofibPrelude.Nil
  } else if (ls instanceof NofibPrelude.Cons.class) {
    param0 = ls.head;
    ...
    if (globalThis.Array.isArray(scrut1) && scrut1.length === 2) {
      ...
      rs_ = first1;
      tmp336 = NofibPrelude.nofibStringToList("\n\n");
      tmp337 = session(rs_, l, ls1);
      tmp338 = NofibPrelude.append(tmp336, tmp337);
      return NofibPrelude.append(response, tmp338)
    } else {
      throw new globalThis.Error("match error");
    }
  } else {
...
testEliza_nofib = function testEliza_nofib(n) {
  let input, tmp335, tmp336, tmp337, tmp338, tmp339, tmp340, tmp341, tmp342, tmp343, tmp344, tmp345, tmp346, tmp347, tmp348, tmp349, tmp350, tmp351, tmp352, tmp353, tmp354, tmp355, tmp356, tmp357, tmp358, tmp359, tmp360, tmp361, tmp362, tmp363, tmp364, lambda1;
  tmp335 = NofibPrelude.nofibStringToList("Are we alone?");
  tmp336 = NofibPrelude.nofibStringToList("That the Roswell event was actually an alien encounter. Do you agreed?");
  tmp337 = NofibPrelude.nofibStringToList("But why not talk about you, its more fun.");
  tmp338 = NofibPrelude.nofibStringToList("I dont ask, you do");
  tmp339 = NofibPrelude.nofibStringToList("do ray me");
  tmp340 = NofibPrelude.nofibStringToList("Nop, thats because your a computer");
  tmp341 = NofibPrelude.nofibStringToList("you dont");
  tmp342 = NofibPrelude.nofibStringToList("Oh, a paranoid computer, ehh?");
  tmp343 = NofibPrelude.nofibStringToList("Tell me about *your* mother");
  tmp344 = NofibPrelude.nofibStringToList("No, what what was she like?");
  tmp345 = NofibPrelude.nofibStringToList("I'm asking questions, not you");
  tmp346 = NofibPrelude.nofibStringToList("no");
  tmp347 = NofibPrelude.nofibStringToList("yes");
  tmp348 = NofibPrelude.nofibStringToList("but I'm not");
  tmp349 = NofibPrelude.Cons(tmp348, NofibPrelude.Nil);
  tmp350 = NofibPrelude.Cons(tmp347, tmp349);
  tmp351 = NofibPrelude.Cons(tmp346, tmp350);
  tmp352 = NofibPrelude.Cons(tmp345, tmp351);
  tmp353 = NofibPrelude.Cons(tmp344, tmp352);
  tmp354 = NofibPrelude.Cons(tmp343, tmp353);
  tmp355 = NofibPrelude.Cons(tmp342, tmp354);
  tmp356 = NofibPrelude.Cons(tmp341, tmp355);
  tmp357 = NofibPrelude.Cons(tmp340, tmp356);
  tmp358 = NofibPrelude.Cons(tmp339, tmp357);
  tmp359 = NofibPrelude.Cons(tmp338, tmp358);
  tmp360 = NofibPrelude.Cons(tmp337, tmp359);
  tmp361 = NofibPrelude.Cons(tmp336, tmp360);
  tmp362 = NofibPrelude.Cons(tmp335, tmp361);
  input = tmp362;
  lambda1 = (undefined, function (i) {
    let tmp365, tmp366, tmp367, tmp368, lambda2, lambda3;
    tmp365 = NofibPrelude.intMod(i, 20);
    tmp366 = NofibPrelude.take(tmp365, input);
    lambda2 = (undefined, function (x) {
      let tmp369;
      tmp369 = trim(x);
      return words(tmp369)
    });
    tmp367 = NofibPrelude.map(lambda2, tmp366);
    lambda3 = (undefined, function (x) {
      let tmp369;
      tmp369 = NofibPrelude.null_(x);
      return BenchmarkPrelude.not(tmp369)
    });
    tmp368 = NofibPrelude.filter(lambda3, tmp367);
    return session(initial, NofibPrelude.Nil, tmp368)
  });
  tmp363 = lambda1;
  tmp364 = NofibPrelude.enumFromTo(1, n);
  return NofibPrelude.map(tmp363, tmp364)
};
...
tmp307 = lscomp(respMsgs);
tmp308 = cycle(repeatMsgs);
initial = [
  tmp307,
  tmp308
];
