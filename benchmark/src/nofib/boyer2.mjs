...
lispListEq = function lispListEq(x, y) {
  ...
  } else if (x instanceof Conss1.class) {
    param0 = x.a;
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      ...
      if (y instanceof Conss1.class) {
        ...
        if (globalThis.Array.isArray(param01) && param01.length === 2) {
          ...
          c = first01;
          d = first11;
          scrut = lispListEq(a, c);
          if (scrut === true) {
            return lispListEq(b, d)
          } else {
            return false
          }
        } else {
...
lispmember = function lispmember(e_x) {
  let first1, first0, e, param0, first11, first01, x, xs, scrut;
  if (globalThis.Array.isArray(e_x) && e_x.length === 2) {
    first0 = e_x[0];
    first1 = e_x[1];
    e = first0;
    if (first1 instanceof Conss1.class) {
      param0 = first1.a;
      if (globalThis.Array.isArray(param0) && param0.length === 2) {
        first01 = param0[0];
        first11 = param0[1];
...
truep = function truep(term_l) {
  let first1, first0, term, l, param0, first11, first01, param01, param02, param1;
  if (globalThis.Array.isArray(term_l) && term_l.length === 2) {
    first0 = term_l[0];
    first1 = term_l[1];
    if (first0 instanceof Nill1.class) {
      return false
    } else if (first0 instanceof Conss1.class) {
      param0 = first0.a;
      if (globalThis.Array.isArray(param0) && param0.length === 2) {
        first01 = param0[0];
        first11 = param0[1];
        if (first01 instanceof Atom1.class) {
          param01 = first01.a;
          if (param01 instanceof NofibPrelude.Cons.class) {
            ...
            if (param02 === "t") {
              if (param1 instanceof NofibPrelude.Nil.class) {
                if (first11 instanceof Nill1.class) {
                  return true
                } else {
                  term = first0;
                  l = first1;
...
cadr = function cadr(x) {
  let tmp217;
  tmp217 = cdr(x);
  return car(tmp217)
};
caddr = function caddr(x) {
  let tmp217, tmp218;
  tmp217 = cdr(x);
  tmp218 = cdr(tmp217);
  return car(tmp218)
};
cadddr = function cadddr(x) {
  let tmp217, tmp218, tmp219;
  tmp217 = cdr(x);
  tmp218 = cdr(tmp217);
  tmp219 = cdr(tmp218);
  return car(tmp219)
};
tautologyp = function tautologyp(f_truelst_falselst) {
  let first2, first1, first0, f, truelst, falselst, param0, first11, first01, x, y, param01, param02, param1, param03, param11, scrut, scrut1, scrut2, scrut3, scrut4, scrut5, param04, x1, tmp217, tmp218, tmp219, tmp220, tmp221, tmp222, tmp223, tmp224, tmp225, tmp226, tmp227, tmp228, tmp229;
  if (globalThis.Array.isArray(f_truelst_falselst) && f_truelst_falselst.length === 3) {
    ...
    truelst = first1;
    falselst = first2;
    if (f instanceof Nill1.class) {
      return false
    } else if (f instanceof Atom1.class) {
      param04 = f.a;
      x1 = param04;
      tmp217 = Atom1(x1);
      return truep([
    ...
    } else if (f instanceof Conss1.class) {
      param0 = f.a;
      if (globalThis.Array.isArray(param0) && param0.length === 2) {
        first01 = param0[0];
        first11 = param0[1];
...
sublist = function sublist(t) {
  let param0, param1, h, t1, scrut, first1, first0, r, l, param01, param11, t2, t3, scrut1, first11, first01, r1, l1, scrut2, first12, first02, r2, l2, tmp217, tmp218, tmp219, tmp220, tmp221, tmp222, tmp223, tmp224, tmp225, tmp226, tmp227, tmp228, tmp229;
...
mkLispList = function mkLispList(ls) {
...
restOfToken = function restOfToken(s) {
  let param0, param1, h, t, scrut, first1, first0, a, b, scrut1, tmp217, tmp218, tmp219, tmp220, tmp221, tmp222;
  if (s instanceof NofibPrelude.Nil.class) {
    ...
    tmp220 = h === " ";
    scrut1 = tmp219 || tmp220;
    if (scrut1 === true) {
      tmp221 = NofibPrelude.Cons(h, t);
      return [
        NofibPrelude.Nil,
        tmp221
      ]
...
getToken = function getToken(s) {
  let param0, param1, h, t, scrut, first1, first0, a, b, scrut1, scrut2, tmp217, tmp218, tmp219, tmp220;
  if (s instanceof NofibPrelude.Nil.class) {
    return [
      NofibPrelude.Nil,
      NofibPrelude.Nil
    ...
    if (scrut2 === true) {
      ...
      tmp217 = h === "(";
      tmp218 = h === ")";
      scrut1 = tmp217 || tmp218;
      if (scrut1 === true) {
        tmp219 = NofibPrelude.Cons(h, NofibPrelude.Nil);
        return [
          tmp219,
          t
        ]
...
strToToken = function strToToken(s) {
  let scrut, first1, first0, a, b, tmp217;
  if (s instanceof NofibPrelude.Nil.class) {
    ...
    if (globalThis.Array.isArray(scrut) && scrut.length === 2) {
      ...
      b = first1;
      tmp217 = strToToken(b);
      return NofibPrelude.Cons(a, tmp217)
    } else {
      throw new globalThis.Error("match error");
    }
  }
};
assoc = function assoc(term_x_y) {
  let first1, first0, term, param0, first11, first01, x, y, param01, first12, first02, param02, key, rest, scrut, tmp217;
      ...
      if (globalThis.Array.isArray(param0) && param0.length === 2) {
        ...
        if (x instanceof Conss1.class) {
          ...
          if (globalThis.Array.isArray(param01) && param01.length === 2) {
            first02 = param01[0];
            first12 = param01[1];
            if (first02 instanceof Atom1.class) {
              param02 = first02.a;
              key = param02;
              rest = first12;
              tmp217 = Atom1(key);
              scrut = lispListEq(term, tmp217);
              if (scrut === true) {
                return x
              } else {
                return assoc([
...
addtoLUT = function addtoLUT(k_l_lut) {
  let first2, first1, first0, k, l, param0, first21, first11, first01, left, first12, first02, k1, kl, right, scrut, scrut1, k2, l1, tmp217, tmp218, tmp219, tmp220, lambda1, lambda2;
  if (globalThis.Array.isArray(k_l_lut) && k_l_lut.length === 3) {
    ...
    k = first0;
    l = first1;
    if (first2 instanceof Empty1.class) {
      tmp217 = NofibPrelude.Cons(l1, NofibPrelude.Nil);
      return Node1([
        Empty1,
        [
          k2,
    ...
    } else if (first2 instanceof Node1.class) {
      param0 = first2.x;
      if (globalThis.Array.isArray(param0) && param0.length === 3) {
        ...
        if (globalThis.Array.isArray(first11) && first11.length === 2) {
          ...
          if (scrut1 === true) {
            ...
            scrut = NofibPrelude.ltList(k, k1, lambda1, lambda2);
            if (scrut === true) {
              tmp219 = addtoLUT([
                k,
                l,
...
getLUT = function getLUT(t_lut) {
  let first1, first0, t, param0, first2, first11, first01, left, first12, first02, k, kl, right, scrut, scrut1, t1, lambda1, lambda2;
  if (globalThis.Array.isArray(t_lut) && t_lut.length === 2) {
    first0 = t_lut[0];
    first1 = t_lut[1];
    t1 = first0;
    t = first0;
    if (first1 instanceof Empty1.class) {
      return NofibPrelude.Nil
    } else if (first1 instanceof Node1.class) {
      param0 = first1.x;
      if (globalThis.Array.isArray(param0) && param0.length === 3) {
        first01 = param0[0];
        first11 = param0[1];
        ...
        if (globalThis.Array.isArray(first11) && first11.length === 2) {
          ...
          if (scrut1 === true) {
            ...
            scrut = NofibPrelude.ltList(t, k, lambda1, lambda2);
            if (scrut === true) {
              return getLUT([
                t,
                left
...
makelemmas = function makelemmas(rules1) {
  let param0, param1, h, t, tmp217, tmp218, tmp219;
  if (rules1 instanceof NofibPrelude.Nil.class) {
    return NofibPrelude.Nil
  } else if (rules1 instanceof NofibPrelude.Cons.class) {
    param0 = rules1.head;
    param1 = rules1.tail;
    h = param0;
    t = param1;
    tmp217 = strToToken(h);
    tmp218 = mkLispList(tmp217);
    tmp219 = makelemmas(t);
    return NofibPrelude.Cons(tmp218, tmp219)
  } else {
    throw new globalThis.Error("match error");
  }
};
addlemma = function addlemma(lspls, term) {
  let param0, first1, first0, x, y, z, scrut, scrut1, param01, x1, tmp217, tmp218, tmp219, tmp220, tmp221, tmp222, tmp223;
  if (lspls instanceof Nill1.class) {
    return term
  } else if (lspls instanceof Atom1.class) {
    param01 = lspls.a;
    x1 = param01;
    throw new globalThis.Error("error");
  } else if (lspls instanceof Conss1.class) {
    param0 = lspls.a;
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      first0 = param0[0];
      first1 = param0[1];
      ...
      z = tmp217;
      tmp218 = tv(x);
      tmp219 = NofibPrelude.nofibStringToList("equal");
      scrut = NofibPrelude.listEq(tmp218, tmp219);
      if (scrut === true) {
        tmp220 = atom(z);
        scrut1 = BenchmarkPrelude.not(tmp220);
        if (scrut1 === true) {
          tmp221 = car(z);
          tmp222 = tv(tmp221);
          tmp223 = Conss1([
...
addlemmalst = function addlemmalst(lspls, term) {
  let param0, param1, h, t, tmp217;
  if (lspls instanceof NofibPrelude.Nil.class) {
    ...
    h = param0;
    t = param1;
    tmp217 = addlemma(h, term);
    return addlemmalst(t, tmp217)
  } else {
    throw new globalThis.Error("match error");
  }
};
applysubstlst = function applysubstlst(alist, y) {
  let param0, first1, first0, x, y1, param01, x1, tmp217, tmp218;
  if (y instanceof Nill1.class) {
    return Nill1
  } else if (y instanceof Atom1.class) {
    param01 = y.a;
    x1 = param01;
    throw new globalThis.Error("error");
  } else if (y instanceof Conss1.class) {
    param0 = y.a;
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      first0 = param0[0];
      first1 = param0[1];
      x = first0;
      y1 = first1;
      tmp217 = applysubst(alist, x);
      tmp218 = applysubstlst(alist, y1);
      return Conss1([
        tmp217,
        tmp218
      ])
...
applysubst = function applysubst(alist, x) {
  let param0, first1, first0, x1, y, param01, x2, scrut, param02, first11, first01, y1, tmp217, tmp218;
  if (x instanceof Nill1.class) {
    return Nill1
  } else if (x instanceof Atom1.class) {
    param01 = x.a;
    ...
    if (scrut instanceof Conss1.class) {
      param02 = scrut.a;
...
onewayunify1lst = function onewayunify1lst(l1, l2, u) {
  let scrut, first1, first0, b, u1, tmp217, tmp218, tmp219, tmp220;
  if (l1 instanceof Nill1.class) {
    return [
      true,
      u
    ]
    ...
    tmp217 = car(l1);
    tmp218 = car(l2);
    scrut = onewayunify1(tmp217, tmp218, u);
    if (globalThis.Array.isArray(scrut) && scrut.length === 2) {
      first0 = scrut[0];
      first1 = scrut[1];
      b = first0;
      ...
      if (b === true) {
        tmp219 = cdr(l1);
        tmp220 = cdr(l2);
        return onewayunify1lst(tmp219, tmp220, u1)
      } else {
        return [
          false,
          u1
...
onewayunify1 = function onewayunify1(t1, t2, u) {
  let scrut, scrut1, scrut2, scrut3, param0, first1, first0, y, tmp217, tmp218, tmp219, tmp220, tmp221, tmp222, tmp223, tmp224, tmp225;
  scrut2 = atom(t2);
  if (scrut2 === true) {
    scrut3 = assoc([
      t2,
    ...
    if (scrut3 instanceof Conss1.class) {
      param0 = scrut3.a;
      if (globalThis.Array.isArray(param0) && param0.length === 2) {
        first0 = param0[0];
        first1 = param0[1];
        y = first1;
        tmp217 = lispListEq(t1, y);
        return [
          tmp217,
          u
        ]
    ...
    if (scrut1 === true) {
      ...
      tmp222 = car(t1);
      tmp223 = car(t2);
      scrut = lispListEq(tmp222, tmp223);
      if (scrut === true) {
        tmp224 = cdr(t1);
        tmp225 = cdr(t2);
        return onewayunify1lst(tmp224, tmp225, u)
      } else {
        return [
          false,
          u
...
onewayunify = function onewayunify(t1, t2) {
  return onewayunify1(t1, t2, Nill1)
};
rewritewithlemmas = function rewritewithlemmas(t, l, term) {
  let param0, param1, lh, lt, scrut, first1, first0, b, u, tmp217, tmp218, tmp219;
  if (l instanceof NofibPrelude.Nil.class) {
    ...
    if (globalThis.Array.isArray(scrut) && scrut.length === 2) {
      ...
      if (b === true) {
        tmp218 = caddr(lh);
        tmp219 = applysubst(u, tmp218);
        return rewrite(tmp219, term)
      } else {
        return rewritewithlemmas(t, lt, term)
      }
    } else {
      throw new globalThis.Error("match error");
    }
...
rewriteargs = function rewriteargs(x, term) {
  let param0, first1, first0, x1, y, param01, tmp217, tmp218;
  if (x instanceof Nill1.class) {
    return Nill1
  } else if (x instanceof Atom1.class) {
    param01 = x.a;
    ...
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      ...
      x1 = first0;
      y = first1;
      tmp217 = rewrite(x1, term);
      tmp218 = rewriteargs(y, term);
      return Conss1([
        tmp217,
        tmp218
      ])
...
rewrite = function rewrite(x, term) {
  let param0, first1, first0, l1, l2, param01, x1, tmp217, tmp218, tmp219, tmp220;
  if (x instanceof Nill1.class) {
    return Nill1
  } else if (x instanceof Atom1.class) {
    param01 = x.a;
    ...
    if (globalThis.Array.isArray(param0) && param0.length === 2) {
      ...
      return rewritewithlemmas(tmp218, tmp220, term)
    } else {
      throw new globalThis.Error("match error");
    }
  } else {
...
subterm = function subterm(i) {
  let c, str, tmp217, tmp218, tmp219, tmp220, tmp221, tmp222, tmp223, tmp224, tmp225, tmp226, tmp227;
  tmp217 = NofibPrelude.stringOfInt(i);
  tmp218 = NofibPrelude.stringConcat("c", tmp217);
  c = tmp218;
  tmp219 = NofibPrelude.nofibStringToList("( ( x f ( plus ( plus a b )( plus ");
  tmp220 = NofibPrelude.nofibStringToList(" ( zero ) ) ) )( y f ( times ( times a b )( plus ");
  tmp221 = NofibPrelude.nofibStringToList(" d ) ) )( z f ( reverse ( append ( append a b ) ( [] ) ) ) )(u equal ( plus a b ) ( difference x y ) )(w lessp ( remainder a b )( member a ( length b ) ) ) )");
  tmp222 = NofibPrelude.stringConcat(c, tmp221);
  tmp223 = NofibPrelude.stringConcat(tmp220, tmp222);
  tmp224 = NofibPrelude.stringConcat(c, tmp223);
  tmp225 = NofibPrelude.stringConcat(tmp219, tmp224);
  str = tmp225;
  tmp226 = NofibPrelude.nofibStringToList(str);
  tmp227 = strToToken(tmp226);
  return mkLispList(tmp227)
};
...
tautp = function tautp(term) {
  let tmp217;
  tmp217 = rewrite(term, lemmas);
  return tautologyp([
    tmp217,
    Nill1,
    Nill1
...
teststatement = function teststatement(i) {
  let tmp217;
  tmp217 = subterm(i);
  return applysubst(tmp217, statement)
};
testresult = function testresult(i) {
  let tmp217;
  tmp217 = teststatement(i);
  return tautp(tmp217)
};
testBoyer2_nofib = function testBoyer2_nofib(n) {
  let tmp217;
  tmp217 = testresult(n);
  return report(tmp217)
};
Lisplist1 = class Lisplist {
  constructor() {}
  toString() { return "Lisplist"; }
};
const Nill$class = class Nill extends Lisplist1 {
  constructor() {
    super();
  }
  toString() { return "Nill"; }
}; Nill1 = new Nill$class;
Nill1.class = Nill$class;
Atom1 = function Atom(a1) {
  return new Atom.class(a1);
};
Atom1.class = class Atom extends Lisplist1 {
  constructor(a) {
    super();
    this.a = a;
  }
...
Conss1 = function Conss(a1) {
  return new Conss.class(a1);
};
Conss1.class = class Conss extends Lisplist1 {
  constructor(a) {
    super();
    this.a = a;
  }
...
const Empty$class = class Empty extends LUT1 {
  constructor() {
    super();
  }
...
Node1 = function Node(x1) {
  return new Node.class(x1);
};
Node1.class = class Node extends LUT1 {
  constructor(x) {
    super();
    this.x = x;
  }
...
rules = tmp214;
tmp215 = makelemmas(rules);
tmp216 = addlemmalst(tmp215, Empty1);
lemmas = tmp216;
lambda = (undefined, function () {
  return testBoyer2_nofib(3)
});
